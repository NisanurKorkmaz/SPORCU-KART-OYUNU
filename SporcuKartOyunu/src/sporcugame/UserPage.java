...
public class UserPage extends javax.swing.JFrame {
    ...
    String yol = "/Users/nisanurkorkmaz/Desktop/JavaApplication17/src/sporcugame/images/";
    ...
    public UserPage(ArrayList<Futbolcu> futList, ArrayList<Basketbolcu> baskList) {
        ...
        System.out.println();
        for (int i = 0; i < 4; i++) {
            System.out.println("kullanıcının basket oyuncusu : " + userBasket.get(i).getBasketbolcuAdi());
        }
        System.out.println();
        ...
        System.out.println();
        for (int i = 0; i < 4; i++) {
            System.out.println("kullanıcının futbolcu oyuncusu : " + userFutbol.get(i).getFutbolcuAdi());
        }
    ...
    private void initComponents() {
        ...
        jTextField3.setBounds(300, 380, 150, 30);
